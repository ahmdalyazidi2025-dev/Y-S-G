            ...
            <div className="relative">
              ...
              >
                <img
                  src="/logo.jpg"
                  alt="Logo"
                  className="w-48 h-48 rounded-full object-cover border-8 border-white/5 shadow-2xl shadow-primary/20"
                />
                <motion.div
                  initial={{ top: "-10%" }}
                  animate={{ top: "110%" }}
              ...
              >
                <div className="relative group">
                  ...
                  <img
                    src="/logo.jpg"
                    alt="Logo"
                    className="w-20 h-20 md:w-24 md:h-24 rounded-full object-cover border-4 border-white/10 shadow-[0_0_40px_rgba(59,130,246,0.3)] relative z-10"
                  />
                </div>
