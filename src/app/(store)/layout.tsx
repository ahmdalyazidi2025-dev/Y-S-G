    ...
    return (
        <ProtectedRoute role="customer">
            <div className="min-h-screen bg-[#101c26] text-white flex flex-col items-center overflow-x-hidden relative">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="relative">
                                    ...
                                    <img
                                        src="/logo.jpg"
                                        alt="Logo"
                                        className="w-12 h-12 rounded-full object-cover border-2 border-white/10 relative z-10 shadow-2xl"
                                    />
                                </div>
                ...
                <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-lg h-20 glass rounded-[32px] z-[50] border border-white/10 shadow-2xl flex items-center justify-around px-2 transition-all">
                    {navItems.map((item) => {
