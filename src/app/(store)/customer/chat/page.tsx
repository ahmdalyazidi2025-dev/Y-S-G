...
export default function ChatPage() {
    ...
    // In a real app, this would be the logged in customer ID
    const currentCustomerId = "guest"
    const currentCustomerName = "عميل"
    ...
    const handleSend = () => {
        if (!msg.trim()) return
        sendMessage(msg, false, currentCustomerId, currentCustomerName)
        setMsg("")
    }
