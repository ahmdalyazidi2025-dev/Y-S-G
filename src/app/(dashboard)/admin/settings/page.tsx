                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={async (e) => {
                                                                ...
                                                                if (confirm("هل أنت متأكد من حذف جميع الدردشات والإشعارات بشكل نهائي؟ لا يمكن التراجع عن هذا الإجراء.")) {
                                                                    ...
                                                                    try {
                                                                        await deleteAllChatsAndNotifications?.((progress: number, status: string) => {
                                                ...
                                                <div key={item.id} className="bg-card border border-border rounded-2xl p-4 flex items-center justify-between shadow-sm">
                                                    <Label className="text-foreground font-bold cursor-pointer" onClick={() => {
                                                        ...
                                                        const updated = isVisible
                                                            ...
                                                            : current.filter((id: string) => id !== item.id) // Currently hidden, so click shows it
                                                    ...
                                                    <Switch
                                                        ...
                                                        onCheckedChange={(checked) => {
                                                            ...
                                                            const updated = !checked
                                                                ...
                                                                : current.filter((id: string) => id !== item.id) // Turn on -> show it
                                                            handleChange("hiddenSections", updated)
                                                        }}
