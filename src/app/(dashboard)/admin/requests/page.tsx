...
import { ArrowRight, Camera, Clock, CheckCircle2, XCircle, Trash2, User, Calendar, MessageSquare } from "lucide-react"
                        ...
                        return (
                            ...
                            >
                                <div className="w-20 h-20 bg-black/40 rounded-xl overflow-hidden flex-shrink-0">
                                    <img src={request.image} alt="product" className="w-full h-full object-cover" />
                                </div>
                ...
                {selectedRequest && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                <div className="aspect-square bg-black/40 rounded-2xl overflow-hidden border border-white/5">
                                    <img src={selectedRequest.image} alt="product" className="w-full h-full object-cover" />
                                </div>
