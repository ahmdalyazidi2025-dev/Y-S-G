        ...
        <>
            {isPreview && (
                <div className="fixed top-6 right-6 z-[1002] flex gap-2 no-print">
                    ...
                    {onClose && (
                        <Button onClick={onClose} variant="ghost" className="bg-white/10 hover:bg-white/20 text-white">
                            إغلاق
                        </Button>
                    )}
                </div>
            ...
            <div id={id} className={containerClasses}>
                <div className={wrapperClasses}>
                    ...
                    <div className="mt-20 pt-8 border-t border-white/5 text-center relative z-10">
                        ...
                        <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.5em] mb-4">Thank you for choosing YSG SALES</p>
