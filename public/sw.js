...
messaging.onBackgroundMessage((payload) => {
    ...
    const notificationTitle = payload.data?.title || payload.notification?.title || 'تنبيه من المتجر 🔔';
...
const CACHE_NAME = 'ysg-sales-v11'; // Forced update for dual-manifest fix
const ASSETS = [
    '/',
    '/manifest.json',
    '/manifest-admin.json',
